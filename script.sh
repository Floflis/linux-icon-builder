...
echo -n "Please write the icon category you want for your icon:"
read iconcategory
...
mkdir icons/256x256
mkdir icons/256x256@2x
mkdir icons/16x16/$iconcategory
mkdir icons/16x16@2x/$iconcategory
mkdir icons/24x24/$iconcategory
mkdir icons/24x24@2x/$iconcategory
mkdir icons/32x32/$iconcategory
mkdir icons/32x32@2x/$iconcategory
mkdir icons/48x48/$iconcategory
mkdir icons/48x48@2x/$iconcategory
mkdir icons/256x256/$iconcategory
mkdir icons/256x256@2x/$iconcategory
